...
const Editar_Editorial = () => {
    ...
    const getEditoriales = () => {
        Axios.get("https://biblioteca-backend-nine.vercel.app/get_editoriales")
            .then((response) => {
    ...
    const updateEditoriales = () => {
        ...
        Axios.put("https://biblioteca-backend-nine.vercel.app/update_editoriales", {
    ...
    const deleteEditorial = (editorialId, nombreEditorial) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Axios.delete(`https://biblioteca-backend-nine.vercel.app/delete_editoriales/${editorialId}`)
                    .then(() => {
                        Swal.fire({
                            title: "Deleted!",
